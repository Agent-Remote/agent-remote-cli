...
pinned by commit and SHA-256; that bootstrap is allowed to request only Bridge `0.1.14`, repository
`Agent-Remote/agent-remote-ego-browser`, profile `community-local-trust` version `0.1.14`, and signer
