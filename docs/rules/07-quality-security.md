...
CI, pre-commit, and pre-push enforce shell parsing, rustfmt, Clippy with warnings denied, all Cargo tests, and whitespace checks. Behavior changes require focused tests; platform-specific changes require the relevant installer or contract coverage.
